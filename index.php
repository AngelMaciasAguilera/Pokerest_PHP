    ...
    <body>
        ...
        <main role="main">
            ...
            <div class="container">
                ...
                ?>
                <div class="row">
                    <h3 style="margin-bottom: 2rem;">pokemons, etc.</h3>
                </div>
                <div class="row">
                    <?php
                    if(isset($_SESSION['user'])) {
                        ?>
                        <a href="user_management/logout.php" class="btn btn-success">log out</a>
                        <?php
                    } else {
                        ?>
                        <a href="user_management/login.php?user=registered" class="btn btn-success">log in</a>
                        &nbsp;
                        &nbsp;
                        &nbsp;
                        <?php
